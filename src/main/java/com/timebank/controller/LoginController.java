...
public class LoginController {
	...
	public String verifyLogin(@RequestParam String email, @RequestParam String password, ModelMap modelMap) {
		...
		for (User user : users) {
			if (user.getEmail().equals(email) && user.getPassword().equals(password)) {
				...
				modelMap.addAttribute("resultMessage",
						"Congratulations " + user.getFullName() + "! You are Successfully Logged in.");
